...
function Calculator() {
  ...
  return (
    <div className="bg-cyan-800 text-white w-screen h-screen flex justify-center items-center">
      <div className="w-64 h-auto bg-teal-900 rounded-2xl shadow-2xl border-4 border-gray-100">
        {/* Screen  */}
        <div className="screen p-2">
          <input type="text" value={result} className="px-1 text-right placeholder-black outline-none rounded-lg bg-gray-100 text-2xl pt-10 w-full text-black" placeholder="0" />
        </div>

        {/* Name  */}
        <div className="brand flex justify-center mb-2 shadow-md text-gray-500 bg-gray-100">
          <h1 className=" text-gray-900 text-xs font-bold">Sisatput</h1>
        </div>
        ...
        <div className="keyboard">
          ...
          <div className="m-2 flex justify-between">
            ...
            <input type="button" value="-" className="bg-amber-300 shadow-md rounded-lg w-12 h-12 text-center text-black font-medium flex justify-center items-center outline-none" onClickCapture={clickHandle} />
          </div>
          <div className="m-2 flex justify-between">
